...
public class Car {
            ...
            if (sc.hasNextInt()) {
                ...
                switch (i) {
                    ...
                    case 202: {
                        ...
                        j = intAsker((int) (this.wheels.get(i).getTyreStatus() * 100) + 1);
                    ...
                    case 301: {
                        ...
                        i = intAsker(this.currentMaxSpeed());
                    ...
                    case 308: {
                        ...
                        j = intAsker((Integer.MAX_VALUE - this.wheels.size()));
                        addWheels(j);
                        System.out.println(this.wheels.size() + " wheels for now.");
                        break;
                    }
    ...
    private int intAsker(int upperMerge) {
        Scanner sc = new Scanner(System.in);
        String s;
        int i;
        while (true) {
